            ...
            <div class="sectionConteent">
                <div class="minCotrolle">
                            <div class="partyContrBnt">
                                        <div class="bntconfig">
                                            <a href="{{ route('Ajoute_Client_all') }}">
                                            <img src="{{ asset('Image/Client.png') }}" alt="img">
                                            <div class="titlebtnconf"> Client</div>
                                            </a>
                                        </div>
                                        <div class="bntconfig">

                                                <a href="{{ route('Ajoute_Fournisseur_all') }}">
                                                    <img src="{{ asset('Image/fornisseu.png') }}" alt="img">
                                                    <div class="titlebtnconf"> Fournisseur</div>
                                                    </a>
                                                </div>

                                        <div class="bntconfig">
                                            <a href="{{ route('Ajoute_produit_all') }}">
                                                <img src="{{ asset('Image/Products.png') }}" alt="img">
                                                <div class="titlebtnconf">Produit</div>
                                            </a>
                                        </div>
                                        <div class="bntconfig">
                                            <a href="{{ route('Pay_Cre_client') }}">
                                                <img src="{{ asset('Image/Paymentmethod.png') }}" alt="img">
                                                <div class="titlebtnconf"> Pay Client </div>
                                            </a>
                                        </div>
                                        <div class="bntconfig">
                                            <a href="{{ route('Pay_Cre_fourni') }}">
                                                <img src="{{ asset('Image/Money.png') }}" alt="img">
                                                <div class="titlebtnconf">Pay Fourni</div>
                                            </a>
                                        </div>
                                        <div class="bntconfig">
                                            <a href="{{ route('Voir_Stock_produit') }}">
                ...
                <div class="userProfil">
                    ...
                    <div class="editBar">
                        <ul>
                            ...
                            <li>
                                <a target="_blank" href="mailto:aymanbenchalh53@gmail.com">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <div class="partymessage">
                        ...
                        @if ($dataproduitMinthre->count()>0 )


                            @foreach ($dataproduitMinthre as $itmProduit)

                                    <div class="message">
                                        <div class="contentmessage">
                                        {{-- !!!  la quantité de produit est faible ( {{ $itmProduit->Quantité  }} ) , Achat nouveau quantité de produit ({{ $itmProduit->Nom_Prod }}). --}}
                                        Le stock du produit  ( {{ $itmProduit->Nom_Prod }} ) est faible ( {{ $itmProduit->Quantité  }} unités ). Vous devez acheter une nouvelle quantité.
                                        </div>

                                    </div>
                            @endforeach
                            @else
                                    <div class="message" style="background-color: #60352A">
                                        <div class="contentmessage" style="text-align: right">
                                            {{-- Tous les produits ont une quantité de stock suffisante. --}}
                                            جميع المنتجات متوفرة حاليًا بكميات كافية لتلبية الطلب. يتم تجديد مخزوننا بانتظام لضمان توافر منتجاتنا. إذا كانت لديك احتياجات محددة أو طلبات خاصة، فلا تتردد في الاتصال بنا حتى نتمكن من مساعدتك.
                                        </div>
