        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                <div class="titleAjoute">
                   Fourisseur
                    <a class="btnAjouteaa" href="{{ route('Ajoute_Fournisseur') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                        ...
                        <table id="tbld" style="padding: 10px">
                            ...
                            <tbody class="table">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('Ajoute_Fournisseur_dl') }}" onsubmit="myfunsubmt(event)"  id="formSumb" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <input type="hidden"  name="NameFourni" value="{{ $itmFourni->nom_Complet }}">
                                                    <input type="hidden"  id="idClient"   name="idClient" value="{{ $itmFourni->id }}">
