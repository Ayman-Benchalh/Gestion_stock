    ...
    <div class="dashbordHome">
        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                <div class="titleAjoute">Paiement Fournisseur
            ...
            @endif
                ...
                <div class="sectionAjouteporduit">
                    <form action="{{ route('Pay_Cre_Fourni_ps') }}" method="post">
                        @csrf
                         <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Fournisseur  : </div></li>
                                    <li>
                                        <select onchange="myfinc({{ $dataFourni }})" name="selectFourni" id="selectClientall">
                                            <option value="refr">select produit</option>
                                            @foreach ( $dataFourni as $FourniItm)
                                            <option  value="{{ $FourniItm->id }}" id="{{ $FourniItm->Montant }}" >{{ $FourniItm->nom_Complet }}</option>
                                            @endforeach
                                        </select>
                                      </li>
                                </ul>
                            ...
                            <div class="unitearty">
                                <ul>
                                    ...
                                    <li><input type="text" readonly name="MontantCredi" id="MontantCredi"  placeholder="Montant Credi"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    ...
                                    <li>
                                        <input type="number" oninput="myfinc2(event)" name="prixPay" max=""  id="prixPay" placeholder="prix total"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
