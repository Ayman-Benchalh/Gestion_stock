...
<div class="container">
        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                <div class="titleAjoute">
                   Produit
                    <a class="btnAjouteaa" href="{{ route('Ajoute_produit') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                    ...
                    <div class="sectionTable-1 edittd">
                        <div class="notifactionRemove" id="notifactionRemove">
                            ...
                            <div class="message" id="message">
                                Voulez-vous vraiment supprimer ce Produit ? <span id="NameUSer" style="color: chocolate"></span>
                            </div>
                            <div class="bntgourpe">
                        ...
                        <table id="tbld" style="padding: 10px">
                            ...
                            <tbody class="table">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('Ajoute_produit_dl') }}" onsubmit="myfunsubmt(event)" method="post" id="formSumb">
                                                    @csrf
                                                    @method('delete')
                                                    <input type="hidden"  name="NameClient" value="{{ $itmProduit->Nom_Prod }}">
                                                    <input type="hidden"  id="idClient"   name="idClient" value="{{ $itmProduit->id }}">
    ...
    <script>
       ...
       console.log(event.target[3].value);
        message.innerHTML=`Voulez-vous vraiment supprimer ce Produit ? <span id="NameUSer" style="color: chocolate">${event.target[2].value}</span>`
        ...
        const  myfunsubmtConfi= (event) =>{
            ...
            if(event.target.hasAttribute('data-confirm')){
                ...
                message.innerHTML=`Produit : <span id='NameUSer' style="color: chocolate">${NameUSer.innerHTML} </span> va être supprimé maintenant. Veuillez confirmer, s'il vous plaît.`
