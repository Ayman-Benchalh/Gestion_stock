    ...
    <div class="dashbordHome">
        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                ...
                <div class="sectionAjouteporduit-1">
                    <form action="{{ route('parametre_page_ps') }}" method="post">
                        @csrf
                         <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Nome et Prenom :</div></li>
                                    <li><input type="text" value="{{ $dataUser->Nom_Complet }}" name="NomComplet"  placeholder="Nom Complet"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Email :</div></li>
                                    <li><input type="email" value="{{ $dataUser->email  }}"   name="Email"   placeholder="email@email.com"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Adresse :</div></li>
                                    <li><input type="text" value="{{ $dataUser->Adresse  }}"   name="Adresse"   placeholder="Adresse , ville ..."></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Nom commercial:</div></li>
                                    <li> <input type="text"  name="NomCommercial" value="{{ $dataUser->Nom_commercial }}" placeholder="nom entreprise  ou commercial"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Telephone:</div></li>
                                    <li><input type="text"  name="Telephone"  value="{{$dataUser->Telephone}}"  placeholder="numero de telephone"></li>
                                </ul>
                            </div>
