    ...
    <div class="dashbordHome">
        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                <div class="titleAjoute">Ajoute Fournisseur
            ...
            @endif
                ...
                <div class="sectionAjouteporduit">
                    <form action="{{ route('Ajoute_Fournisseur') }}" method="post">
                        @csrf
                         <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Nom Complet :  </div></li>
                                    <li><input type="text" name="NomComplet" id="nomporduit" placeholder="nom et prenom"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Email :</div></li>
                                    <li><input type="email" name="email" id="email" placeholder="@email.com"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Adresse  :</div></li>
                                    <li><input type="text" name="Adresse" id="Adresse" placeholder="adresse ville"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Telephone   :</div></li>
                                    <li><input type="text" name="Telephone" id="Telephone" placeholder="+212...."></li>
                                </ul>
                            </div>
