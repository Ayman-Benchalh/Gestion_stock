    ...
    <div class="dashbordHome">
        ...
        <div class="partyContent">
            ...
            <div class="sectionConteent">
                <div class="titleAjoute">Ajoute Produit
            ...
            @endif
                ...
                <div class="sectionAjouteporduit">
                    <form action="{{ route('Ajoute_produit') }}" method="post">
                        @csrf
                         <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Nom produit : </div></li>
                                    <li><input type="text" name="nomproduit" id="nomporduit" value="{{ old('nomproduit') }}" placeholder="Nom produit"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Designation :</div></li>
                                    <li><input type="text" name="designation" id="designation" value="{{ old('designation') }}" placeholder="type , couleur ..."></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Catégorie :</div></li>
                                    <li><input type="text" name="Catégorie" id="Catégorie" value="{{ old('Catégorie') }}" placeholder="goupe type Catégorie"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
                                    <li><div class="titlenom">Quantité  :</div></li>
                                    <li><input type="number" name="quantité" id="quantité" value="{{ old('quantité') }}" placeholder="number de produit"></li>
                                </ul>
                            </div>
                            <div class="unitearty">
                                <ul>
